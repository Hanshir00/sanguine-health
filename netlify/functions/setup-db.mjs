  ...
  if (parseInt(bookCount[0].count) === 0) {
    await sql`
      ...
      VALUES (
        ...
        'View Availability & Book →','https://calendly.com/YOUR-LINK-HERE',
        'Choose your session type','Initial assessment, specialty session, or protocol review.',
        'Pick your time','Select from available slots in your timezone.',
        'Complete intake form','A short pre-session questionnaire so we hit the ground running.'
      )
    `;
  }
